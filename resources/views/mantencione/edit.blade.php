        ...
        <div class="">
            <div class="col-md-12">
                ...
                <div class="card card-default">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('mantenciones.update', $mantencione->id_mantencion) }}"
                            ...
                            <div id="probado-bajo-agua">
                                ...
                                <p class="mb-2">Probado bajo agua
                                <p>
                                <div class="row">
                                    <div class="mr-3 ml-2"><input type="radio" class="radios "
                                            name="probado_bajo_agua" value="Si">Si</div>
                                    <div class=""><input type="radio" class="radios "
                                            name="probado_bajo_agua" value="No">No</div>
                                </div>
                            </div>
                            <div id="verificacion-reparacion">

                                <label><input type="radio" class="mr-2" id="verificacion_reparacion" value=""
                                        name="verificacion_reparacion">Reparado</label><br>
                            </div>
