...
{{-- <div id="verificacion-reparacion">
    ...
    <label><input type="radio" class="mr-2" id="verificacion_reparacion" value="SI" name="verificacion_reparacion">Si</label>
    <label><input type="radio" class="mr-2" id="verificacion_reparacion" value="No" name="verificacion_reparacion">No</label><br><br>
</div> --}}
...
<div class="row pl-2">
<div class="form-group btn btn-primary btn-sm " id="imagen1">
    {{ Form::label('imagen1') }}
...
<div class="row pl-2">
<div class="form-group btn btn-primary btn-sm " id="imagen2">
    {{ Form::label('imagen2') }}
...
<div class="row pl-2">
<div class="file-field">
<div class="form-group  btn btn-primary btn-sm" id="imagen3">
    {{ Form::label('imagen3') }}
